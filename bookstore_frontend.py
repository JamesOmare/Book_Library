...
# We wrap the following in try block because when clicking
# an empty listbox an error(Index out of bounds) will show in the terminal although the 
# program will continue normally. If you clickon an empty listbox then no error occurs due to the pass command in the except block
    try:
        #This selects the first index of the tuple which is the id
...
def add_command():
    ...
    tkinter.messagebox.showinfo("Hi There:)", "Book Details have been added succesfully!")
